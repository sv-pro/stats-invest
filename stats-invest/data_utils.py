"""
Utility functions for fetching, generating, and processing cryptocurrency data.
"""
import os
import pandas as pd
import numpy as np
...
def fetch_historical_data(crypto_id, days=constants.HISTORICAL_DAYS):
    """
    ...
    """
    print(f"Fetching historical data for {constants.CRYPTO_NAME} (ID: {crypto_id})...")
    ...
    url = f"{constants.CMC_API_URL}/cryptocurrency/quotes/historical"
    
    # Headers with API key
    headers = {
        'X-CMC_PRO_API_KEY': constants.CMC_API_KEY,
    ...
    params = {
        ...
        'interval': constants.FETCH_INTERVAL,
        'convert': constants.CMC_QUOTE_CURRENCY
    }
    ...
    try:
        ...
        for quote in quotes:
            ...
            price = quote['quote'][constants.CMC_QUOTE_CURRENCY]['price']
...
def generate_sample_data(days=constants.HISTORICAL_DAYS):
    """
...
def save_to_csv(df, crypto_symbol=constants.CRYPTO_SYMBOL):
    """
...
def get_weekly_data():
    ...
    """
    crypto_symbol = constants.CRYPTO_SYMBOL
    crypto_id = constants.CRYPTO_ID
