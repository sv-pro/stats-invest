"""
Constants and configuration for the Z-Score cryptocurrency investment strategy.
These values can be overridden by environment variables in .env file.
"""
import os
...
# Common cryptocurrency symbols and IDs for CoinMarketCap
