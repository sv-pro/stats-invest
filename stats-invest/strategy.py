"""
Core implementation of the Z-Score based investment strategy.
"""
import pandas as pd
import numpy as np
...
class ZScoreInvestmentStrategy:
    def __init__(self, window_size=constants.WINDOW_SIZE, weekly_investment=constants.WEEKLY_INVESTMENT):
        """
    ...
    def determine_investment_amount(self, z_score):
        ...
        for p, z_threshold in constants.Z_SCORE_THRESHOLDS:
    ...
    def plot_results(self, results, crypto_symbol=constants.CRYPTO_SYMBOL):
